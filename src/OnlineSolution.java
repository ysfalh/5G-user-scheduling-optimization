...
public class OnlineSolution extends Solution {
	public static void main(String[] args) {
		...
		for (int i = 0; i < iter; i++) {
			...
			Input ipt2 = new Input(4, 2, 10, 100);
			
			Solution sol = new Solution(ipt);
			Solution s = new Solution(ipt2);
			try {
//				sol.online(75, pmax, rmax);
//				sol.online2(pmax, rmax);
...
//				s.Display();
		...
		System.out.println("Nombre de dépassements de contraintes en pourcentage : "+100*(double)nAlert/iter+"%");
	}
}
